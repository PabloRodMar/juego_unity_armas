...
public partial class @Controles: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Main Camera"",
            ""id"": ""7328bf92-ab4a-4528-a80b-c39c22472634"",
            ""actions"": [
                {
                    ""name"": ""Zoom"",
                    ""type"": ""Value"",
                    ""id"": ""c23c1121-8138-490e-9049-4ddb1a4c1f83"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""0dfaaf56-a1df-4616-be97-be88f2cd9181"",
                    ""path"": ""<Mouse>/scroll/y"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": []
        ...
        // Main Camera
        m_MainCamera = asset.FindActionMap("Main Camera", throwIfNotFound: true);
    ...
    ~@Controles()
    {
        ...
        UnityEngine.Debug.Assert(!m_MainCamera.enabled, "This will cause a leak and performance issues, Controles.MainCamera.Disable() has not been called.");
    }
    ...
    /// <summary>
    /// Provides access to input actions defined in input action map "Main Camera".
    /// </summary>
    public struct MainCameraActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public MainCameraActions(@Controles wrapper) { m_Wrapper = wrapper; }
        /// <summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Main Camera" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="MainCameraActions.AddCallbacks(IMainCameraActions)" />
    /// <seealso cref="MainCameraActions.RemoveCallbacks(IMainCameraActions)" />
